...
class DDist:
    """Discrete distribution represented as a dictionary.  Can be sparse, in the sense that elements that are not
    explicitly contained in the dictionary are assumed to have zero probability."""
    ...
    def setProb(self, elt, p):
        ...
        @param p: probability
        Sets probability of elt to be p
        """
        self.d[elt] = p
    ...
    def addProb(self, val, p):
        """
        Increase the probability of element val by p
        """
